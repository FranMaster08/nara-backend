...
export class UserController {
  ...
  @ApiOperation({
    ...
    description:
      'Lista de usuarios con filtros opcionales, paginación y orden.',
  })
  @ApiOkResponse({
  ...
  @ApiQuery({
    name: 'email',
    required: false,
    description: 'Email contiene (case-insensitive)',
  })
  ...
  @ApiQuery({
    name: 'sortBy',
    required: false,
    enum: ['name', 'email', 'createdAt', 'birthDate'],
  ...
  @ApiOperation({
    ...
    description: 'Admin o el propio usuario.',
  })
